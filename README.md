...
Backend tests cover state transitions, RBAC denial/audit logging, request submission, project ownership visibility, project member management and reassignment, approval information requests, CTO override, approval history and role-change visibility, cancellation, extension requests, incidents, notifications, executive reporting, usage/cost/budget evidence, audit/cost allocation export, policy versioning/evaluation, and mock provisioning through approval. Frontend tests cover request form validation.
