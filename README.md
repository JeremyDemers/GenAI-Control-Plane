...
- Provisioning, usage/budget processing, restore, archive/deprovision, and cost allocation delivery jobs are durably queued and can be drained by the worker; local inline execution remains enabled by default for demo velocity.
...
1. Move notification delivery to durable async jobs.
