...
Backend tests cover state transitions, RBAC denial/audit logging, request submission, project ownership visibility, project member management and reassignment, approval information requests, approval history visibility, cancellation, extension requests, incidents, notifications, executive reporting, usage/cost/budget evidence, audit export, policy versioning/evaluation, and mock provisioning through approval. Frontend tests cover request form validation.
